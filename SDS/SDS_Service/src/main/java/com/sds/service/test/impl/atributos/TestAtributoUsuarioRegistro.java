...
public class TestAtributoUsuarioRegistro {
	...
	public DatosPruebaAtributos getTestRegistroUsuarioVacio(final Registro datosEntradaRegistroUsuarioVacio) {
		...
		final String resultadoObtenido = validacionesAtributosBlank.comprobarAtributoBlank(
				datosEntradaRegistroUsuarioVacio.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO);
		...
		return crearDatosPruebaAtributos.createDatosPruebaAtributos(resultadoObtenido, resultadoEsperado,
				DefinicionPruebas.VACIO, Constantes.ERROR, datosEntradaRegistroUsuarioVacio.getDatosUsuario().getUsuario(),
				Constantes.USUARIO);
	}

	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoEnhe(
			final Registro datosEntradaRegistroUsuarioAlfanumericoEnhe) {

		final String resultadoObtenido = validacionesAtributosEnhe.comprobarAtributoEnhe(
				datosEntradaRegistroUsuarioAlfanumericoEnhe.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO);
	...
	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoAcentos(
			final Registro datosEntradaRegistroUsuarioAlfanumericoAcentos) {

		final String resultadoObtenido = validacionesAtributosAcentos.comprobarAtributoAcentos(
				datosEntradaRegistroUsuarioAlfanumericoAcentos.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO);
	...
	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoCaracteresEspeciales(
			final Registro datosEntradaRegistroUsuarioAlfanumericoCaracteresEspeciales) {

		final String resultadoObtenido = validacionesAtributosCaracteresEspeciales
				.comprobarAtributoCaracteresEspeciales(
						datosEntradaRegistroUsuarioAlfanumericoCaracteresEspeciales.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR,
						Atributo.USUARIO);
		...
		return crearDatosPruebaAtributos.createDatosPruebaAtributos(resultadoObtenido, resultadoEsperado,
				...
				datosEntradaRegistroUsuarioAlfanumericoCaracteresEspeciales.getDatosUsuario().getUsuario(), Constantes.USUARIO);
	}

	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoEspacios(
			final Registro datosEntradaRegistroUsuarioAlfanumericoEspacios) {

		final String resultadoObtenido = validacionesAtributosEspacios.comprobarAtributoEspacios(
				datosEntradaRegistroUsuarioAlfanumericoEspacios.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO);
	...
	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoMenor3(
			final Registro datosEntradaRegistroUsuarioAlfanumericoMenor3) {

		final String resultadoObtenido = validacionesAtributosMenor.comprobarAtributoMenor(
				datosEntradaRegistroUsuarioAlfanumericoMenor3.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO, 3);
	...
	public DatosPruebaAtributos getTestRegistroUsuarioAlfanumericoMayor45(
			final Registro datosEntradaRegistroUsuarioAlfanumericoMayor45) {

		final String resultadoObtenido = validacionesAtributosMayor.comprobarAtributoMayor(
				datosEntradaRegistroUsuarioAlfanumericoMayor45.getDatosUsuario().getUsuario(), Funcionalidad.REGISTRAR, Atributo.USUARIO, 45);
	...
	public DatosPruebaAtributos getTestRegistroUsuarioCorrectoAlfanumerico(final Registro datosEntradaLoginUsuario) {
		...
		return crearDatosPruebaAtributos.createDatosPruebaAtributos(resultadoObtenido, resultadoEsperado,
				DefinicionPruebas.ALFANUMERICO_CORRECTO, Constantes.EXITO, datosEntradaLoginUsuario.getDatosUsuario().getUsuario(),
				Constantes.USUARIO);
