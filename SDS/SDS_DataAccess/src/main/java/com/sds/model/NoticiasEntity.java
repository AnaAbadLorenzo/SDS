...
@NamedQueries({ @NamedQuery(name = "NoticiasEntity.findAllNoticias", query = "SELECT n FROM NoticiasEntity n"),
		...
		@NamedQuery(name = "NoticiasEntity.findNoticia", query = "SELECT n FROM NoticiasEntity n WHERE n.tituloNoticia LIKE CONCAT('%', :tituloNoticia, '%') AND n.textoNoticia LIKE CONCAT('%',:textoNoticia, '%') AND (:fechaNoticia IS NULL OR n.fechaNoticia LIKE :fechaNoticia)"),
		@NamedQuery(name = "NoticiasEntity.numberFindNoticia", query = "SELECT COUNT(n) FROM NoticiasEntity n WHERE n.tituloNoticia LIKE CONCAT('%', :tituloNoticia, '%') AND n.textoNoticia LIKE CONCAT('%',:textoNoticia, '%') AND (:fechaNoticia IS NULL OR n.fechaNoticia LIKE :fechaNoticia)"),
