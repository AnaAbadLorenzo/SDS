...
@NamedQueries({
		...
		@NamedQuery(name = "EmpresaEntity.findEmpresa", query = "SELECT e FROM EmpresaEntity e WHERE e.cifEmpresa LIKE UPPER (CONCAT('%', :cifEmpresa, '%')) AND e.nombreEmpresa LIKE UPPER (CONCAT('%', :nombreEmpresa, '%')) AND e.direccionEmpresa LIKE UPPER (CONCAT('%', :direccionEmpresa, '%')) AND e.telefonoEmpresa LIKE UPPER (CONCAT('%',:telefonoEmpresa, '%')) AND e.borradoEmpresa=0"),
		@NamedQuery(name = "EmpresaEntity.numberFindEmpresa", query = "SELECT COUNT(e) FROM EmpresaEntity e WHERE e.cifEmpresa LIKE UPPER (CONCAT('%', :cifEmpresa, '%')) AND e.nombreEmpresa LIKE UPPER (CONCAT('%', :nombreEmpresa, '%')) AND e.direccionEmpresa LIKE UPPER (CONCAT('%', :direccionEmpresa, '%')) AND e.telefonoEmpresa LIKE UPPER (CONCAT('%',:telefonoEmpresa, '%')) AND e.borradoEmpresa=0"),
