...
@Table(name = "empresa")
@NamedQueries({
		@NamedQuery(name = "EmpresaEntity.findAllEmpresas", query = "SELECT e FROM EmpresaEntity e WHERE e.borradoEmpresa = 0"),
		@NamedQuery(name = "EmpresaEntity.numberFindAllEmpresas", query = "SELECT COUNT(e) FROM EmpresaEntity e WHERE e.borradoEmpresa = 0"),
		@NamedQuery(name = "EmpresaEntity.findEmpresa", query = "SELECT e FROM EmpresaEntity e WHERE LOWER(e.cifEmpresa) LIKE LOWER(CONCAT('%', :cifEmpresa, '%')) AND LOWER(e.nombreEmpresa) LIKE LOWER(CONCAT('%', :nombreEmpresa, '%')) AND LOWER(e.direccionEmpresa) LIKE LOWER(CONCAT('%', :direccionEmpresa, '%')) AND e.telefonoEmpresa LIKE (CONCAT('%',:telefonoEmpresa, '%')) AND e.borradoEmpresa=0"),
		@NamedQuery(name = "EmpresaEntity.numberFindEmpresa", query = "SELECT COUNT(e) FROM EmpresaEntity e WHERE LOWER(e.cifEmpresa) LIKE LOWER(CONCAT('%', :cifEmpresa, '%')) AND LOWER(e.nombreEmpresa) LIKE LOWER(CONCAT('%', :nombreEmpresa, '%')) AND LOWER(e.direccionEmpresa) LIKE LOWER(CONCAT('%', :direccionEmpresa, '%')) AND e.telefonoEmpresa LIKE (CONCAT('%',:telefonoEmpresa, '%')) AND e.borradoEmpresa=0"),
