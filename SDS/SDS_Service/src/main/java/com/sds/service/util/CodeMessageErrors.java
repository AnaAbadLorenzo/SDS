...
public enum CodeMessageErrors {
	...
	ROL_NO_EXISTE_EXCEPTION("ROL_NO_EXISTE_EXCEPTION"), //
	ROL_YA_EXISTE_EXCEPTION("ROL_YA_EXISTE_EXCEPTION"), //
	NO_HAY_ROLES_EXCEPTION("NO_HAY_ROLES_EXCEPTION"), //
	ROL_ASOCIADO_USUARIO_EXCEPTION("ROL_ASOCIADO_USUARIO_EXCEPTION"), //
	ROL_VACIO("ROL_VACIO");
