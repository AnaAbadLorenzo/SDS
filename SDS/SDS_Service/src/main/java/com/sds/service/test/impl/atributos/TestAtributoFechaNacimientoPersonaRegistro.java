...
public class TestAtributoFechaNacimientoPersonaRegistro {
	...
	public DatosPruebaAtributos getTestRegistroFechaNacimientoPNumericoCaracteresEspeciales(
		...
		final String resultadoObtenido = validacionesAtributosCaracteresEspeciales
				.comprobarAtributoCaracteresEspeciales(datosEntradaRegistroFechaNacimientoPNumericoCaracteresEspeciales
						.getDatosPersona().getFechaNacP().toString(), Funcionalidad.REGISTRAR,
		...
		return crearDatosPruebaAtributos.createDatosPruebaAtributos(resultadoObtenido, resultadoEsperado,
				...
				datosEntradaRegistroFechaNacimientoPNumericoCaracteresEspeciales.getDatosPersona().getFechaNacP()
						.toString(),
				Constantes.FECHANACP);
	}
	...
	public DatosPruebaAtributos getTestRegistroFechaNacimientoPAlfanumericoMenor8(
		...
		final String resultadoObtenido = validacionesAtributosMenor.comprobarAtributoMenor(
				...
				Funcionalidad.REGISTRAR, Atributo.FECHA_NACIMIENTO, 8);
	...
	public DatosPruebaAtributos getTestRegistroFechaNacimientoPersonaCorrectoNumerico(
			final Registro datosEntradaRegistroFechaNacimientoPersona) {

		final String resultadoObtenido = validacionesAtributosCorrectoFechas.comprobarAtributoCorrectoFechas(
				datosEntradaRegistroFechaNacimientoPersona.getDatosPersona().getFechaNacP().toString());
